 ...
 * Use the [CreditScoreFragment.newInstance] factory method to
...
class CreditScoreFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreditScoreFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance() = CreditScoreFragment().apply {
